...
export const mockUsers: User[] = [
    currentUser,
    {
        ...
        country: "United States",
        skills: ["Machine Learning", "Python", "Research Methods", "Data Science"],
        interests: ["AI Ethics", "Climate Tech"],
    ...
    },
    {
        ...
        university: "MIT",
        country: "United States",
        skills: ["Blockchain", "Solidity", "TypeScript", "React"],
        interests: ["Web3", "DeFi", "Startups"],
        goals: [UserGoal.Startup],
        xp_level: ExperienceLevel.Intermediate,
        trust_level: TrustLevel.Gold,
        trust_score: 85,
        badges: [],
    ...
    },
    {
        ...
        skills: ["Python", "Data Analysis", "Research Methods", "Statistics"],
        interests: ["Healthcare", "Public Policy"],
        goals: [UserGoal.Research, UserGoal.Internship],
...
// =========================================
// Interest Groups for community search
// =========================================
...
export const interestGroups: InterestGroup[] = [
    {
        id: "group_001",
        name: "AI Researchers",
        description: "Community for AI/ML research discussions and paper reviews",
        category: "Research",
        icon: "🤖",
        memberCount: 234,
    },
    {
        id: "group_002",
        name: "Climate Tech Founders",
        description: "Connecting students building climate solutions",
        category: "Startup",
        icon: "🌱",
        memberCount: 156,
    },
    {
        id: "group_003",
        name: "Berkeley Network",
        description: "UC Berkeley students and alumni",
        category: "University",
        icon: "🐻",
        memberCount: 489,
    },
    {
        ...
        description: "Aspiring and current PMs sharing insights",
        category: "Career",
        icon: "📊",
        memberCount: 312,
    },
