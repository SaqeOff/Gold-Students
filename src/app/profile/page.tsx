...
export default function ProfilePage() {
    ...
    const displayUser = authUser?.role === "student" ? {
        ...currentUser,
        name: authUser.name,
        email: authUser.email || displayUser.email,
        university: authUser.university || displayUser.university,
        bio: authUser.country ? `🌍 ${authUser.country}` : displayUser.bio,
        skills: authUser.skills.length > 0 ? authUser.skills : displayUser.skills,
        goals: authUser.goals.length > 0 ? authUser.goals.map((g: string) => ({ id: g, title: g, description: "", category: "personal" })) : displayUser.goals,
    } : currentUser;
