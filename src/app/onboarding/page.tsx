                        ...
                        <div className="flex-1">
                            ...
                            {currentStep === 1 && (
                                <div className="space-y-6 animate-pulse-fade-in">
                                    <div className="text-center mb-8">
                                        <GlitchText className="text-2xl font-bold text-white mb-2">IDENTIFICATION</GlitchText>
                            ...
                            {currentStep === 2 && (
                                <div className="space-y-6 animate-pulse-fade-in">
                                    <div className="text-center mb-8">
                                        <GlitchText className="text-2xl font-bold text-white mb-2">PRIMARY_OBJECTIVE</GlitchText>
                            ...
                            {currentStep === 3 && (
                                <div className="space-y-6 animate-pulse-fade-in">
                                    <div className="text-center mb-8">
                                        <GlitchText className="text-2xl font-bold text-white mb-2">SKILL_MATRIX</GlitchText>
                                ...
                                <div className="py-8 animate-pulse-fade-in flex flex-col items-center justify-center h-full">
                                    <div className="text-center mb-12">
                                        <GlitchText className="text-2xl font-bold text-white mb-2">
                                            {analysisComplete ? "ACCESS_GRANTED" : "PROCESSING_DATA"}
                                        </GlitchText>
